...
public abstract class SbbConstraintsProfileCMPWrongVisibilitySbb implements javax.slee.Sbb {
	...
	// fake cmp interface
	public abstract ProfileCmpInterface getFirstProfileCMP(ProfileID id)
			throws UnrecognizedProfileTableNameException,
			UnrecognizedProfileNameException;

	protected abstract SuperProfileInterface probeSecondProfileCMP(ProfileID id)
			throws UnrecognizedProfileTableNameException,
			UnrecognizedProfileNameException;
