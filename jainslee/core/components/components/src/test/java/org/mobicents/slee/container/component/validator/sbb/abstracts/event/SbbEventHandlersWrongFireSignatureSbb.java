 ...
 */
public abstract class SbbEventHandlersWrongFireSignatureSbb extends SbbConstraintsOkSbb {
	...
	public abstract void fireCustomEventFour(XEvent event,
			ActivityContextInterface aci, Address address, ServiceID SID,String s);
