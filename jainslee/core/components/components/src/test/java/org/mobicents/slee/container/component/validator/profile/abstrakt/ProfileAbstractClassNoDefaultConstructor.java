 ...
 */
public abstract class ProfileAbstractClassNoDefaultConstructor implements javax.slee.profile.Profile,ManagementInterfaceOk, ProfileBaseCMPInterface
{
	...
	public ProfileAbstractClassNoDefaultConstructor(String x) {
		super();
