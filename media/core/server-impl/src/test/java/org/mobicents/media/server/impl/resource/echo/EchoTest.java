...
public class EchoTest {
    ...
    private SineGeneratorFactory playerFactory;
    ...
    public void setUp() throws Exception {
        ...
        playerFactory = new SineGeneratorFactory();
        ...
        transmittor.setSourceFactory(sources);
        transmittor.setSinkFactory(sinks);
    ...
    public void testTransmission() throws Exception {
        Connection connection1 = echo.createLocalConnection();
        connection1.setMode(ConnectionMode.SEND_RECV);
        Connection connection2 = transmittor.createLocalConnection();
...
//        System.out.println("Format=" + player.getFormat());
...
//        player.start();
        ...
        assertTrue("Expected other number of packets", Math.abs(500 - count) < 60);
