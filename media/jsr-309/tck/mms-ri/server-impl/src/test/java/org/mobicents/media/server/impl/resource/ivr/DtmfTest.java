...
public class DtmfTest implements NotificationListener {
    ...
    public void testSimpleTransmission() throws Exception {
        Connection connection1 = ivrEndpoint1.createConnection(ConnectionMode.SEND_RECV);
        Connection connection2 = ivrEndpoint2.createConnection(ConnectionMode.SEND_RECV);
        ...
        DtmfGenerator gen = (DtmfGenerator) connection1.getComponent("dtmf.gen", Connection.CHANNEL_TX);
        DtmfDetector det = (DtmfDetector) connection2.getComponent("dtmf.det", Connection.CHANNEL_RX);
        det.start();
