 ...
 * @author amit bhayani
 */
public class AdvancedAudioPlayerTest {
	...
	private AdvancedAudioPlayerImpl player;
	private TestSink sink;

	public AdvancedAudioPlayerTest() {
	}
	...
	public void setUp() {
		...
		player = new AdvancedAudioPlayerImpl("test", timer);
	...
	public void test_TTS() throws Exception {
		...
		player.setVoice("kevin");
		sink.setSupportedFormat(Codec.LINEAR_AUDIO);
		sink.setSize(320);
   ...
   @Test
    public void testFailure() throws Exception {
        ...
        player.setURL(file);       
        sink.setSupportedFormat(AVProfile.PCMA);
        player.connect(sink);
        sink.start();
        player.start();
