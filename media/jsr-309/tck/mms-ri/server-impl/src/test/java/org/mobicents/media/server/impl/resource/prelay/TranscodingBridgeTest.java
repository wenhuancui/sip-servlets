...
public class TranscodingBridgeTest {
    ...
    public void setUp() throws Exception {
        ...
        rxFactories.put("audio", prChannelFactory);

        Hashtable txFactories = new Hashtable();
        txFactories.put("audio", prChannelFactory);
        
        ConnectionFactory prConnectionFactory = new ConnectionFactory();
        prConnectionFactory.setRxChannelFactory(rxFactories);
        prConnectionFactory.setTxChannelFactory(txFactories);
        ...
        packetRelayEnp.setRtpFactory(rtpFactory1);
