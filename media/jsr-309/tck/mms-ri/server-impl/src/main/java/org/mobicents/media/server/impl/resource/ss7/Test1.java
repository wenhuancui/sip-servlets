...
//        String[] data = "bf 7d f7 d8 00 0e 46 77 ef be fb 00 01 c8 ce fd f7 df 60 00 39 19 df be fb ec 00 07 23 3b f7 df 7d 80 00 e4 67 7e fb ef b0 00 1c 8c ef 7d f6".split(" ");
    	...
    	File f = new File("G:/tmp/data.hex");
        ...
        while (i < len) {
			while (h.bits <= 24 && i < len) {
				...
				b = Integer.parseInt(data[i++],16) & 0xff;
    ...
    System.err.println("Frame Count: "+frameCount);
    System.err.println("Error Count: "+errorCount);
    System.err.println("SIGMA Count: "+((double)errorCount/frameCount));
