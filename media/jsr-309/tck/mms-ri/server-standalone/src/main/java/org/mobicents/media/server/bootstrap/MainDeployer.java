 ...
 * 
 * Deployement is represented by tree of folders. Each folder may contains one or more deployement descriptors. 
 * The most top deployment directory is referenced as root. Maindeployer creates recursively HDScanner for root and 
 * each nested directoty. The HDScanner corresponding to the root directory is triggered periodicaly by local timer 
 * and in it order starts nested scanners recursively.
 * 
 * @author kulikov
 * @author amit bhayani
 */
public class MainDeployer {
     ...
     * 
     * @param scanPeriod the value of the period in milliseconds.
     */
    ...
    public void start(Kernel kernel, BasicXMLDeployer kernelDeployer) {
        ...
        HDScanner scanner = new HDScanner(root);
        scanner.run();
     ...
     * 
     * @param file the reference to the deployment descriptor
     ...
     * Deployment scanner.
     * 
     * The scanner relates to a directory in the deployement structure. It is responsible for processing all 
     * descriptors in this directotry and for triggering nested scanners.
     */
    private class HDScanner implements Runnable {
         ...
         * 
         * @param dir the directory releated to this scanner.
         */
         ...
         * 
         * It shoudl find changes in the deployement structure and execute 
         * corresponding method:
         * 
         * -deploy for new descriptors; 
         * -undeploy for removed descriptors;
         * -redeploy for updated descriptors;
         * -create nested scanner for new nested directories;
         * -remove nested scanner for deleted nested directories;
         * -run nested scanners recursively.
         */
        public void run() {
         ...
         * 
         * @param files the list of descriptors.
         ...
         * 
         * @param files the list of currently available descriptors
         ...
         *  
         * @param files the fresh list of descriptors.
