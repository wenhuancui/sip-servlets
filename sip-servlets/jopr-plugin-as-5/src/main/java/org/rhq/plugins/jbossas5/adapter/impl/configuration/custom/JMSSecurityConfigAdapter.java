 ...
 * MapCompositeValueSupport} with the key being a JMS security role name and the value being a {@link
 * CompositeValueSupport}s representing the role's read/write/create permissions. Here's what the PropertyList looks
 * like:
 * <p/>
 * <code> &lt;c:list-property name="securityConfig" min="2" max="4" displayName="Security Configurations"
 ...
 * required="false" type="boolean"/&gt; &lt;/c:map-property&gt; &lt;/c:list-property&gt; </code>
 *
 * @author Ian Springer
 */
