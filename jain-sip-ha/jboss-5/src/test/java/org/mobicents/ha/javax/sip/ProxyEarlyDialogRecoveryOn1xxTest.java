...
public class ProxyEarlyDialogRecoveryOn1xxTest extends TestCase {
    ...
    SimpleStatefulProxy proxyNode1;
    
    SimpleStatefulProxy proxyNode2;
        ...
        public void processResponse(ResponseEvent responseEvent) {
        	...
        	try {
        		if(stopNodeOnReinvite && responseEvent.getResponse().getStatusCode() == Response.RINGING) {
            		...
            		proxyNode2.stopPingBalancer();
                    proxyNode2.stop(false);                     
            	}
        ...
        public void processResponse(ResponseEvent responseReceivedEvent) {        	
            ...
            try {
            	...
            	if(failoverOn1xx && response.getStatusCode() == Response.RINGING) {
                	// stop the sip stack w/o stopping the cache
            		proxyNode1.stopPingBalancer();
                    proxyNode1.stop(false);                     
            	}
